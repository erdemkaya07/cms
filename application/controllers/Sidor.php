<?php 
class Sidor extends CI_Controller
{
	public $viewFolder = "";
	...
	{
		parent::__construct();
		$this->viewFolder = "sidor_v";
		$this->load->model("sidor_model");
	...
	public function index()
	{
		...
		//All data come here
		$items = $this->sidor_model->get_all(
			array(), "rank ASC"
		);
	...
	public function update($id)
	{
		...
		$validate = $this->form_validation->run();
		if($validate){
			$update = $this->sidor_model->update(
				array(
					"id" => $id
				),
				array(
	...
	{
		$delete = $this->sidor_model->delete(
			array(
				"id"	=> $id
			)
		);
	...
	public function imageForm($id)
	{
		...
		$viewData->item = $this->sidor_model->get(
			array(
				"id"	=> $id
			)
		);
